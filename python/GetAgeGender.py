...
if __name__ == '__main__':
    ...
    # Set the parameter for model
    faceProto = "../modelzoo/agegender/opencv_face_detector.pbtxt"
    faceModel = "../modelzoo/agegender/opencv_face_detector_uint8.pb"

    ageProto = "../modelzoo/agegender/age_deploy.prototxt"
    ageModel = "../modelzoo/agegender/age_net.caffemodel"

    genderProto = "../modelzoo/agegender/gender_deploy.prototxt"
    genderModel = "../modelzoo/agegender/gender_net.caffemodel"
    ...
    while(True):
        ...
        ret, frame = cap.read()
        ir not ret:
            print("E0001: Can not read the video")
            break

        # Detect face in frame
        frameFace, bboxes = getFaceBox(faceNet, frame)
        if not bboxes:
            print("W0001: No face Detected, Checking next frame")
            continue
